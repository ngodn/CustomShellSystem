"""Compare reset-only and equal-axis inertia controls on the same walk cycle."""
import hashlib
import json
import math
...
report={}
for control,name in [(8,'reset-only'),(12,'cube'),(15,'cube-no-spring-contact')]:
    path=work/f'motion-inertia-{name}.json'
...
(work/'motion-inertia.json').write_text(json.dumps(report,indent=2)+'\n')
