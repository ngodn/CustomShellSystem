...
| CSSX Performance extension loads, models, applies, restores | host runtime harness with a fake engine (2026-09-22) | Pass; live in-game check of an applied scalability change not yet |
